...
var expectedPermissions = map[identity.Role][]identity.Permission{
	...
	identity.RoleAdmin: {
		...
		identity.PermAuditRead,
		identity.PermViewKeys,
		identity.PermManageKeys,
		identity.PermBreakGlassKeys,
		identity.PermViewPrivacy,
		identity.PermManagePrivacy,
		...
		identity.PermViewAlerting,
		identity.PermManageAlerting,
		identity.PermViewPilot,
		identity.PermManagePilot,
		identity.PermViewRelease,
		identity.PermManageRelease,
	},
