...
const (
	...
	// a bearer token).
	CredentialKindOAuthClientCredentials CredentialKind = "oauth_client_credentials" // #nosec G101 -- this is a label naming the auth *shape*, not a credential value //nolint:gosec
