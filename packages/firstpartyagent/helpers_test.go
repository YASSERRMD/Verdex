...
const testCaseID = "case-firstpartyagent"
...
// VectorStore for testCaseID, mirroring packages/issueagent's own test
// fixture composition exactly.
type fixture struct {
	caseID string
...
// packages/issueagent's own test helper.
...
// fake completion, mirroring packages/issueagent's own test helper.
