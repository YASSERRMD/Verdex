...
var (
	...
	ErrMalformedModelOutput = errors.New("firstpartyagent: malformed model output")
	...
	ErrNoTemplate = errors.New("firstpartyagent: no argument-construction template available")
	...
	ErrNoGroundedArguments = errors.New("firstpartyagent: no arguments survived grounding validation")
)
