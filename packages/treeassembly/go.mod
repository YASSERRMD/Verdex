module github.com/YASSERRMD/verdex/packages/treeassembly

go 1.25.0

require (
	github.com/YASSERRMD/verdex/packages/application v0.0.0-00010101000000-000000000000
	github.com/YASSERRMD/verdex/packages/fact v0.0.0-00010101000000-000000000000
	...
	github.com/YASSERRMD/verdex/packages/issue v0.0.0-00010101000000-000000000000
)

require (
	github.com/YASSERRMD/verdex/packages/config v0.0.0 // indirect
	github.com/YASSERRMD/verdex/packages/evidence v0.0.0-00010101000000-000000000000 // indirect
	github.com/YASSERRMD/verdex/packages/observability v0.0.0-00010101000000-000000000000 // indirect
	...
	github.com/YASSERRMD/verdex/packages/timeline v0.0.0-00010101000000-000000000000 // indirect
...
replace (
	github.com/YASSERRMD/verdex/packages/application => ../application
