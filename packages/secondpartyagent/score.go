...
// packages/firstpartyagent/score.go's own saturating-count convention
...
//
// Mirrors packages/firstpartyagent/score.go's strengthScore exactly — the
// scoring approach is party-agnostic, so the second-party agent evaluates
// its own arguments' strength by the same rubric the first-party agent
// uses, keeping the two adversarial outputs directly comparable for
// Phase 053's evidence-weighing module and Phase 055's synthesis agent.
//
