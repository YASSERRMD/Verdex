...
// under. Mirrors firstpartyagent.ArgueConfig's shape exactly.
...
// Argue runs the second-party argument Agent for caseID end to end:
...
// convenience-entry convention exactly, so Phase 053's evidence-weighing
// module and Phase 055's synthesis agent consume this package the same
// way they consume packages/firstpartyagent.
//
