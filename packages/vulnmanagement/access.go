...
// managePermission is the identity.Permission required to record
// findings, triage them, and transition their Status.
const managePermission = identity.PermManageVulnmanagement

// viewPermission is the identity.Permission required for read-only
// access to findings, triage history, SLA-breach reports, and the
// vulnerability-management dashboard.
const viewPermission = identity.PermViewVulnmanagement
...
// can manage findings can also read them.
...
// packages/threatmodel.requireMatchingUserTenant exactly -- an actor's
